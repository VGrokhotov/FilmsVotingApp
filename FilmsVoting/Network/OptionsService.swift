...
class OptionsService {
    ...
    func getTopOptionsByRoomID(roomID: UUID?, errorCompletion: @escaping (String) -> (), completion: @escaping ([Option]) -> ()) {
        ...
        components.scheme = scheme
        components.host = host
        components.path = optionsPath + selectorPath + topPath
                ...
                if let error = error {
                    ...
                    if let options = options {
                        ...
                        if let dataError = dataError {
                            ...
                            DispatchQueue.main.async {
                                errorCompletion("Wrong TopOption data from server, please, send the sсreenshot of this message to developer")
                            }
                        }
